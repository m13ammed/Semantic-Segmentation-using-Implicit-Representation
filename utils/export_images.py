...
def export_images(labels, target_images, show_only=False, batch=0,batch_size=5,frame_skip=20, scene_name="1", colored=True):
    ...
    for idx in range(target_images.shape[0]):
        ...
        if(show_only):
            ...
            frame_id = batch*batch_size*20+idx*20
