...
from dataloader.litdata import LitDataCo3D, LitDataScannet, LitDataPefceptionScannet
...
def select_dataset(
    ...
    elif dataset_name == "perfception_scannet":
        data_fun = LitDataPefceptionScannet
