...
def export_images(target_images):
...
if __name__ == "__main__":
    ...
    cameras, target_images = generate_gt_renders(poses=poses, polygon_path=polygon_file, device=device)
    export_images(target_images=target_images)
